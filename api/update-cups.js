import { findPlayer, updatePlayerCups } from './_data.js';
...
export default async function handler(req, res) {
  ...
  try {
    ...
    const updated = updatePlayerCups(cleanNick, cups);
    return res.status(200).json({ success: true, newTotal: updated.cups });
